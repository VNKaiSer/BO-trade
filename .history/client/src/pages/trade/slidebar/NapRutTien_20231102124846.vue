          ...
          <div class="boxAddress">
            ...
            <div v-else>
              <div class="transfer-network">
                ...
                >
                  <span class="font-bold">Chú ý:</span> Chuyển tiền đúng nội
                  dung và không lưu lại thông tin chuyển khoản!
                  <br />
                  <br />
                  <span> </span>Bạn vui lòng liên hệ với CSKH Binacesky để nạp
                  tiền để đảm bảo! ATTT
                </p>
                ...
                <div>
                  <div class="md:w-full">
                    ...
                    <div class="infobank" v-if="isNap">
                      ...
                      <div class="relative form-group">
                        <h4 class="text-center colorSecondary2">
                          Tên Ngân Hàng
                        </h4>
                        <input
                          v-model="namebank"
                          ...
                          readonly="readonly"
                          id="namebank"
                          class="bgSecondary colorSecondary2 amountbank"
                        />
                      </div>
                      <div class="relative form-group">
                        <h4 class="text-center colorSecondary2">
