                ...
                <div class="showV" :class="{block: showVC}">
                    <div class="box-coin-wrapper">
                        <div class="flex flex-col items-baseline justify-between lg:flex-row">
                            <h4 class="mb-3 text-2xl font-bold color-white">Tài khoản chính:</h4>
                            <!-- <h6 class="mb-0 italic colorGray"><span >Giá trị ước tính: {{ giaTriUocTinh }} USD</span></h6> -->
                        </div>
                        <div class="vx-row">
                            <div class="w-full mb-3 vx-col lg:w-1/2" v-if="getSetSys.isActiveWalletUSDT">
                                <div class="boxCoin">
                            ...
                            <div class="w-full mb-3 vx-col lg:w-1/2" v-if="getSetSys.isActiveWalletETH">
                                <div class="boxCoin">
                                    <div class="boxCoin-body">
                                        <div class="flex flex-col leftBox sm:flex-row">
                                            <div class="flex items-center">
                            ...
                            <div class="w-full mb-3 vx-col lg:w-1/2" v-if="getSetSys.isActiveWalletBTC">
                                <div class="boxCoin">
                                    <div class="boxCoin-body">
                                        <div class="flex flex-col leftBox sm:flex-row">
                                            <div class="flex items-center">
                            ...
                            <div class="w-full mb-3 vx-col lg:w-1/2" v-if="getSetSys.isActiveWalletPaypal">
                                <div class="boxCoin">
                                    <div class="boxCoin-body">
                                        <div class="flex flex-col leftBox sm:flex-row">
                                            <div class="flex items-center">
                        ...
                        <div class="vx-row">
                            <div class="w-full mt-4 vx-col lg:w-1/2">
                                <div class="background backgroundImg backgroundLive">
                                    <div class="flex flex-col items-center justify-center content">
                                        <span class="text-lg font-bold color-gray sm:mb-3">Tài khoản Thực</span>
                                        <span class="flex items-center mb-2 price mb:sm-3">
                                            <span class="text-3xl font-bold">${{ formatPrice(blObj.blLive, 2) }}</span>
                                        </span>
                                        <button @click="popupTransferActive=true" type="button" class="w-9/12 cursor-pointer btn button wbtn btn-large btn-radius">
                            ...
                            <div class="w-full mt-4 vx-col lg:w-1/2">
                                <div class="background backgroundImg backgroundDemo">
                                    <div class="flex flex-col items-center justify-center content">
                                        <span class="text-lg font-bold color-gray sm:mb-3">Tài khoản Demo</span>
                                        <span class="flex items-center mb-2 price mb:sm-3">
                                            <span class="text-3xl font-bold">${{ formatPrice(blObj.blDemo, 2) }}</span>
                                        </span>
                                        <button @click="clickReloadMoneyDemo" type="button" class="w-9/12 cursor-pointer btn button wbtn btn-large btn-radius">
        ...
        <div class="flex flex-col items-center content">
            <div class="relative w-3/4 mb-3 inputGroup">
                ...
                <div class="input-append">
                    <button type="button" class="cursor-pointer btn" @click="enterAllMoney">Tất cả</button>
                </div>
            </div>
...
components: {
  ...
  data () {
    return {
        ...
        blObj: getData,
        textWalletHtml: '<span class="mr-1 uppercase color-blue green">USDT</span> <span>Wallet</span>',
