        ...
        <div class="block pc">
          <div class="mb-6">
            ...
            <div class="flex items-center justify-between gap-1">
              <p class="w-full p-1 mt-2 text-center vx-col md:w-6/12">Thời Gian:</p>
              <select>
                <option class="w-full h-8 cursor-pointer bpF" value="">30s</option>
                <option class="w-full h-8 cursor-pointer bpF" value="">60s</option>
                <option class="w-full h-8 cursor-pointer bpF" value="">120s</option>
              </select>
            </div>
