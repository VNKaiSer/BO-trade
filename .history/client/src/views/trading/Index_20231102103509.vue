            ...
            <div class="slider sidebarMobile" style="height: 180px">
              <div class="slidercontent">
                ...
                <div
                  ...
                  style="height: 172px; margin-left: 10px"
                >
                  <span class="font-12 zIndex99" style="color: rgb(252, 95, 95)"
                    >{{ CSSELL }}%</span
                  >
                  <vs-progress
                    style="width: 130px"
              ...
              <div class="flex justify-center ct">
                <div class="vx-row">
                  <div class="vx-col w-18 list1">
                    <span
                      class="inline-flex m-1 rounded-full gridcs-1 item empty"
                    ></span>
                    <span
                      class="inline-flex m-1 rounded-full gridcs-1 item empty"
                    ></span>
                    ...
                    ></span>
                    <span
                      class="inline-flex m-1 rounded-full gridcs-2 item empty"
                    ></span>
                    <span
                      class="inline-flex m-1 rounded-full gridcs-2 item empty"
                    ></span>
                    ...
                    ></span>
                    <span
                      class="inline-flex m-1 rounded-full gridcs-3 item empty"
                    ></span>
                    <span
                      class="inline-flex m-1 rounded-full gridcs-3 item empty"
                    ></span>
                    ...
                    ></span>
                    <span
                      class="inline-flex m-1 rounded-full gridcs-4 item empty"
                    ></span>
                    <span
                      class="inline-flex m-1 rounded-full gridcs-4 item empty"
                    ></span>
                    ...
                    ></span>
                    <span
                      class="inline-flex m-1 rounded-full gridcs-5 item empty"
                    ></span>
                    <span
                      class="inline-flex m-1 rounded-full gridcs-5 item empty"
                    ></span>
    ...
    updateCandleStickChart(boPrice) {
      ...
      try {
        ...
        f.label &&
          f.label.attr({
            text:
              '<div class="flex flex-col plotlineChart"><span class="price">' +
              boPrice.close +
              '</span><span class="self-end time">00:' +
