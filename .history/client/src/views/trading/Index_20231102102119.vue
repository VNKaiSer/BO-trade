...
<template>
  <div id="tradePage" class="trade-container">
    <div class="m-0 vx-row">
        <div class="relative w-full vx-col xl:w-10/12">
            <div class="h-full">
                <div class="relative chartBox">
                    ...
                    <div class="flex items-center titleChartCandle">
                ...
                <div id="analysis-wrapper" class="relative analysis-wrapper">
                    <vs-tabs>
                            ...
                            <div class="gauge-meter">
                                <div class="gauge-meter-sub gauge-meter--os">
                                    <div class="v-popover gauge-meter-popover">
                                        <div class="inline-block trigger">
                    ...
                    <div class="historyBox" :class="{active: !activeGau, hidden: activeHis}">
                        <div class="flex items-center overviewInfo">
                            <span class="badgeItem">
                                <span class="font-bold uppercase color-green">Mua</span>
                                <span> {{ totalBuyStatic }}</span>
                            </span>
                            <span class="ml-2 badgeItem">
                                <span class="font-bold uppercase color-red">Bán</span>
                                <span> {{ totalSellStatic }}</span>
                            </span>
                        </div>
                        <div class="flex justify-center ct">
                            <div class="vx-row">
                                <div class="vx-col w-18 list1">
                                    <span class="inline-flex m-1 rounded-full gridcs-1 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-1 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-1 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-1 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-2 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-2 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-2 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-2 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-3 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-3 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-3 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-3 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-4 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-4 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-4 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-4 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-5 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-5 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-5 item empty"></span>
                                    <span class="inline-flex m-1 rounded-full gridcs-5 item empty"></span>
                                </div>
        ...
        <div class="w-full vx-col xl:w-2/12 rightBar">
            <div class="block pc">
                <div class="mb-6">
                    <div class="mt-2 mb-2">
                        Tiền cược
                ...
                <div class="mb-10 text-center lg:relative">
                    ...
                    <div class="block">
                        <span class="float-left color-green">
                            {{ CSBUY }}%
                        </span>
                        <span class="float-right color-red">
                            {{ CSSELL }}%
                        </span>
                    </div>
                </div>
                ...
                <div class="mt-10 mb-5 lg:relative">
                    <div class="pb-1 col-md-12 col-4 bet-box-time" style="border: 1px solid #fa2843;border-radius: 4px;background-color: #1d233b;">
                        <a class="flex flex-col items-center justify-center btn btn-trade-time btnTransparent w-100" style="height: 37px; color: #fff">
                            <p class="mb-0 font-14" style="line-height: normal;" :class="{'text-danger': !isBet}">{{ textTimeDown }}:
                                <span class="mb-0 ml-1 font-bold timer_counter second" style="line-height: normal;">{{ seconDown }}s</span>
                            </p>
                        </a>
                    </div>
                    <div class="h-6"></div>
                    <vs-button @click="BetBuySell('buy')" :disabled="!isBet" class="w-full h-16 mb-3 font-bold" color="success" type="relief">
                    MUA
                ...
                <div class="wrapNotify congratulation h-100 ">
                    <div class="boxNotify">
                        ...
                        <div class="flex flex-col items-center justify-center boxContent">
                            ...
                            <p class="titleWin">Xin chúc mừng!</p> <span class="text-4xl font-bold message_money">+{{ moneyWin }}$</span>
                        </div>
    ...
    updateCandleStickChart(boPrice) {
                ...
                try{
                    ...
                    f.label && f.label.attr({
                        text : '<div class="flex flex-col plotlineChart"><span class="price">' + boPrice.close + '</span><span class="self-end time">00:' + (counter > 9 ? counter : "0" + counter) + '</span></div>'
                    });
