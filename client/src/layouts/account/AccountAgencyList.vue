    ...
    <div id="loading-corners" class="vs-con-loading__container">
      ...
      >
        ...
        <template slot="thead">
          ...
          <vs-th sort-key="memberForAgency">{{ $t("QWEFS") || "QWEFS" }}</vs-th>
          <vs-th sort-key="pending_commission">{{ $t("GRW") || "GRW" }}</vs-th>
          <vs-th sort-key="secury2fa">{{ $t("ASDAC") || "ASDAC" }}</vs-th>
        ...
        <template slot-scope="{ data }">
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
                <p class="font-medium truncate agency-name">
