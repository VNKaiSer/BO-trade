  ...
  <div id="list-bet-trade" class="data-list-container">
    ...
    <div id="loading-corners" class="vs-con-loading__container">
      ...
      >
        ...
        <template slot="thead">
          <vs-th sort-key="description">{{ $t("DSAEQWD") || "DSAEQWD" }}</vs-th>
          <vs-th sort-key="type">{{ $t("DSAADG") || "DSAADG" }}</vs-th>
          <vs-th sort-key="buy_sell">{{ $t("DSAGAD") || "DSAGAD" }}</vs-th>
          <vs-th sort-key="amount">{{ $t("DSAGA") || "DSAGA" }}</vs-th>
          <vs-th sort-key="win_lose">{{ $t("DSAGS") || "DSAGS" }}</vs-th>
          <vs-th sort-key="result_bet"></vs-th>
          ...
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              <template v-if="tr.type_account">
                <vs-td>
                  <p class="font-medium truncate bet-description">
                    Email: {{ tr.email }}
                  </p>
                  <p class="font-medium truncate bet-description">
                    ID: {{ tr.id_account }}
                  ...
                  <p
                    class="font-medium truncate bet-description"
                    v-if="tr.type_account"
                  >
                    Live Account
                  </p>
                  <p class="font-medium truncate bet-description" v-else>
                    Demo Account
                  </p>
                </vs-td>
                ...
                <vs-td>
                  ...
                  <p class="bet-buy_sell" v-else>
                    <span class="text-danger">{{ $t("DSAV") || "DSAV" }}</span>
                  </p>
                </vs-td>
                ...
                <vs-td>
                  <p class="bet-result_bet" v-if="tr.amount_win != 0">
                    <span class="text-success">{{ $t("DSAS") || "DSAS" }}</span>
                  </p>
                  <p class="bet-result_bet" v-else>
                    <span class="text-danger">{{ $t("DSAW") || "DSAW" }}</span>
                  </p>
                </vs-td>
