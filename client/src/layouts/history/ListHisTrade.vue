    ...
    <div id="loading-corners" class="vs-con-loading__container">
      ...
      >
        ...
        <template slot="thead">
          ...
          <vs-th sort-key="note">{{ $t("SADWF") || "SADWF" }}</vs-th>
          <vs-th sort-key="status">{{ $t("DSAD") || "DSAD" }}</vs-th>
        ...
        <template slot-scope="{ data }">
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              <vs-td>
                <p class="font-medium truncate trade-account">
                  {{ $t("KISOS") || "KISOS" }}: {{ tr.from_u }}<br />{{
                    $t("KISSOS") || "KISSOS"
                  }}: {{ tr.to_u }}<br /><br />{{ $t("DSAQQ") || "DSAQQ" }}:
                  {{ tr.type }}
                </p>
              </vs-td>
              ...
              <vs-td class="text-center whitespace-no-wrap"> </vs-td>
