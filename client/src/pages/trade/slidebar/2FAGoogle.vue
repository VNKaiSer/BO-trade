<template>
  <div class="m-10 gg" v-if="!isActive2FA">
    <p class="mb-2 text-center description color-white-50">
      {{ $t("KSD") || "KSD" }}
    </p>
    <div class="qrcode">
      <div class="loading">
      ...
      <div class="items-center mb-5 vx-row mb-sm-4 ccQR">
        <div class="mb-3 text-center md:w-5/12 qr-code-wrap mb-md-0">
          <div class="mx-auto qr-code-container qr-200">
            <img
              height="150"
              width="150"
              :src="linkBase64Img"
      ...
      <div class="vx-row backupkey">
        ...
        <div class="pl-0 pr-0 md:w-9/12 key pr-lg-3">
        ...
        <div class="w-full">
          <div class="relative">
            <vs-input
              class="w-full"
              :label="$t('SDLOSA') || 'SDLOSA'"
              v-model="codeActive"
            />
            <!--<span class="paste">Paste</span>-->
          </div>
          <div class="float-right w-1/5 text-right" style="margin-top: 1rem">
    ...
    <div class="qrcode">
      ...
      <div class="vx-row backupkey">
        ...
        <div class="w-full">
          ...
          <div class="float-right text-right" style="margin-top: 1rem">
            <!-- Không nhận được mail: <a href="https://t.me/ares_idefibo_bot" target="_blank">Click</a> -->
            <vs-button
              id="button-with-loading"
              class="vs-con-loading__container"
