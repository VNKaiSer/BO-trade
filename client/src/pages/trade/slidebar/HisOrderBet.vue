            ...
            <vs-tabs alignment="fixed">
                ...
                <div class="tabClose" :class="{'hidden': !isCloseTab, 'block': isCloseTab}">
                  <div class="con-tab-ejemplo">
                        <div v-if="listItemOpen.length == 0" class="flex flex-col items-center justify-center h-a">
                            ...
                            <p class="mt-3 text-sm text-center color-grey">Bạn chưa có lệnh nào đang mở</p>
                        </div>
                        <div v-else class="flex flex-col justify-center">
                           <div :key="indextr" v-for="(oknha, indextr) in listItemOpen">
                                <p class="mt-3 mb-3 font-16 color-gray">{{ fromatTimzoneD(oknha.time) }}</p>
                                <div class="mb-2 text-sm transactionBox">
                                    ...
                                    <div class="flex justify-between mb-2 text-white">
                                        <span class="flex trendGroup align-items-center">
                                            <span class="mr-2 trendIcon" :class="{'trendUp': oknha.type == 'buy', 'trendDown': oknha.type == 'sell'}"></span>
                ...
                <div class="tabOpen" :class="{'hidden': !isOpenTab, 'block': isOpenTab}">
                  <div class="con-tab-ejemplo">
                        <div v-if="listItem.length == 0" class="flex flex-col items-center justify-center h-a">
                            <img src="data:image/svg+xml;base64," alt="" class="imageLandScape">
                            <p class="mt-3 text-sm text-center color-grey">Bạn chưa có lệnh đóng nào</p>
                        </div>
                        <div v-else class="flex flex-col justify-center">
                           <div :key="indextr" v-for="(oknha, indextr) in listItem">
                                ...
                                <div class="mb-2 text-sm transactionBox">
                                    ...
                                    <div class="flex justify-between mb-2 text-white">
                                        <span class="flex trendGroup align-items-center">
                                            <span class="mr-2 trendIcon" :class="{'trendUp': oknha.bs == 'buy', 'trendDown': oknha.bs == 'sell'}"></span>
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-bold totalWin" :class="{'winUp': oknha.aw > 0, 'winDown': oknha.aw == 0}" >
