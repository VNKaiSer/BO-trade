<template>
  <div class="boxFix">
    <div class="boxAuthentication" :class="{ show: activeSlide }" v-if="activeLogin">
      <div class="contentAuthentication bgPrimary flex flex-col items-center justify-between"
        ...
        <div class="header-sidebar p-6 fixed flex items-center justify-between flex-col w-full">
          <div class="header w-full">
            ...
            <div class="close-page">
              <feather-icon icon="XIcon" @click.stop="(activeLogin = !activeLogin), redirectHome()"
          ...
          <div class="formWapper w-full">
            <div class="loginForm white mt-0" v-if="!isG2FA">
              ...
              <div class="centerx labelx">
                <div class="mb-3">
                  <vs-input type="email" class="w-full" label="Địa chỉ Email *" placeholder="Điền Email"
                    v-model="email" />
                </div>
                <div class="mb-3 relative">
                  <vs-input class="w-full" :type="passTypeLog" label="Mật khẩu *" placeholder="Điền mật khẩu"
                    v-model="password" />
                  <feather-icon icon="EyeOffIcon" svgClasses="w-5"
                    :class="{ hidden: !activeL1, 'inline-block': activeL1 }" @click="
                      (activeL1 = false), (activeL2 = true), showPassLogin()
                      " class="viewPass cursor-pointer" />
                  <feather-icon icon="EyeIcon" svgClasses="w-5" :class="{ 'inline-block': activeL2, hidden: !activeL2 }"
                    @click="
                ...
                <div>
                  <router-link to="/forgot-password" class="mb-5 inline-block float-right cursor-pointer">Quên mật
                    khẩu?</router-link>
                  <vs-button color="success" class="w-full" type="filled" :disabled="!disabledLogin"
                    @click="loginForm">Đăng nhập</vs-button>
                </div>
              </div>
            </div>
            <div class="loginForm white mt-0" v-else>
              ...
              <div class="centerx labelx">
                ...
                <div>
                  <vs-button color="success" class="w-full" type="filled" :disabled="!disabledLogin"
                    @click="loginFormAuthG2FA">Gửi</vs-button>
                </div>
              </div>
            </div>
          </div>
          <div slot="footer">
            ...
            <div class="colorWhite">
              ...
              <router-link to="/register-resend-verify-email" class="cursor-pointer">
      ...
      <div class="contentAuthentication bgPrimary flex flex-col items-center justify-between"
        ...
        <div class="header-sidebar p-6 fixed flex items-center justify-between flex-col w-full">
          <div class="header w-full">
            <a href="/" class="logoLogin mb-0 router-link-active">BoTrade</a>
            <div class="close-page">
              <feather-icon icon="XIcon" @click="(activeRegister = !activeRegister), redirectHome()"
                class="cursor-pointer" />
            </div>
          </div>
          <div class="formWapper w-full">
            <div class="regFrom white mt-0" v-if="!isSubmitReg">
              ...
              <div class="centerx labelx">
                <div class="mb-5 relative" :class="{ 'md-invalid': msgEmReg != '' }">
                  <vs-input type="email" class="w-full" name="emailReg" label="Địa chỉ Email *" placeholder="Điền Email"
                    v-model="emailReg" />
                ...
                <div class="mb-5 relative" :class="{ 'md-invalid': msgPassReg != '' }">
                  <vs-input class="w-full" name="password" v-validate="'required|min:6|max:20'" maxlength="20"
                    :type="passTypeReg" label="Mật khẩu *" placeholder="Điền mật khẩu" v-model="passwordReg" />
                  <feather-icon icon="EyeOffIcon" svgClasses="w-5"
                    :class="{ hidden: !activeE1, 'inline-block': activeE1 }" @click="
                      (activeE1 = false), (activeE2 = true), showPassReg()
                      " class="viewPass cursor-pointer" />
                  <feather-icon icon="EyeIcon" svgClasses="w-5" :class="{ 'inline-block': activeE2, hidden: !activeE2 }"
                    @click="
                ...
                <div class="mb-5 relative" :class="{ 'md-invalid': msgNickName != '' }">
                  <vs-input class="w-full" maxlength="20" name="nickName" label="Biệt danh *" placeholder="Điền Nickname"
                    v-model="nickName" />
                  <small class="md-error text-danger text-sm">
                    {{ msgNickName }}
                  </small>
                ...
                <div class="mb-5 relative" :class="{ 'mt-10': msgNickName != '' }">
                  <vs-input class="w-full" label="Mã giới thiệu / Mã khuyến mãi" placeholder="Điền Mã giới thiệu"
                    v-model="codeRef" />
                </div>
                <div>
            ...
            <div v-if="isSubmitReg">
              ...
              <br />
              <p>
                <button class="btn btn-resendemail w-full mt-4" @click="openSite">
          ...
          <div class="formWapper w-full">
            <div class="ResendForm white mt-0" :class="{ block: hideTbResend, hidden: !hideTbResend }">
              ...
              <div class="centerx labelx">
                ...
                <div>
                  <vs-button color="success" class="w-full" type="filled" @click="submitFormResendActive">Gửi
                    lại</vs-button>
                </div>
              </div>
            </div>
      ...
      <div class="contentAuthentication bgPrimary flex flex-col items-center justify-between"
        ...
        <div class="header-sidebar p-6 fixed flex items-center justify-between flex-col w-full">
          <div class="header w-full">
            <a href="/" class="logoLogin mb-0 router-link-active">BoTrade</a>
            <div class="close-page">
              <feather-icon icon="XIcon" @click="(activeFogotPass = !activeFogotPass), redirectHome()"
                class="cursor-pointer" />
            </div>
          </div>
          <div class="formWapper w-full">
      ...
      <div class="contentAuthentication bgPrimary flex flex-col items-center justify-between"
        ...
        <div class="header-sidebar p-6 fixed flex items-center justify-between flex-col w-full">
          <div class="header w-full">
            <a href="/" class="logoLogin mb-0 router-link-active">BoTrade</a>
            <div class="close-page">
              <feather-icon icon="XIcon" @click="(activeResetPass = !activeResetPass), redirectHome()"
                class="cursor-pointer" />
            </div>
          </div>
          <div class="formWapper w-full">
            <div class="fotgotForm white mt-0" :class="{ block: hideTbForgot, hidden: !hideTbForgot }">
              ...
              <div class="centerx labelx">
                <div hidden>
                  <vs-input type="email" disabled="disabled" class="w-full" v-model="codeReset" />
                </div>
                <div class="mb-5 relative" :class="{ 'md-invalid': msgEmReset != '' }">
                  <vs-input type="email" disabled="disabled" class="w-full" label="Địa chỉ Email *"
                    v-model="emailReset" />
                  <small class="md-error text-danger text-sm">
                    {{ msgEmReset }}
                  </small>
                ...
                <div class="mb-5 relative" :class="{ 'md-invalid': msgPassReset != '' }">
                  <vs-input class="w-full" maxlength="20" :type="passTypeReset" label="Mật khẩu mới *"
                    v-model="passwordReset" />
                  <feather-icon icon="EyeOffIcon" svgClasses="w-5"
                    :class="{ hidden: !activeRs1, 'inline-block': activeRs1 }" @click="
                      (activeRs1 = false), (activeRs2 = true), showPassReset()
                      " class="viewPass cursor-pointer" />
                  <feather-icon icon="EyeIcon" svgClasses="w-5" :class="{ 'inline-block': activeRs2, hidden: !activeRs2 }"
                    @click="
                ...
                <div class="mb-5 relative" :class="{ 'md-invalid': msgPassReReset != '' }">
                  <vs-input class="w-full" maxlength="20" :type="passTypeReReset" label="Xác nhận mật khẩu *"
                    v-model="passwordReReset" />
                  <feather-icon icon="EyeOffIcon" svgClasses="w-5"
                    :class="{ hidden: !activeRss1, 'inline-block': activeRss1 }" @click="
                      (activeRss1 = false),
                      (activeRss2 = true),
                      showPassReReset()
                      " class="viewPass cursor-pointer" />
                  <feather-icon icon="EyeIcon" svgClasses="w-5"
                    :class="{ 'inline-block': activeRss2, hidden: !activeRss2 }" @click="
                      (activeRss1 = true),
                      (activeRss2 = false),
                      showPassReReset()
                      " class="viewPass cursor-pointer" />
                ...
                <div class="mt-2">
                  <vs-button color="success" class="w-full" type="filled" @click="submitFormResetPass">Đặt lại mật
                    khẩu</vs-button>
                </div>
              </div>
            </div>
