<template>
  <div id="AffiliatePage">
          ...
          <div class="container h-full">
            <div class="items-center h-full vx-row">
              <div class="vx-col lg:w-6/12">
                <p class="mb-4 text-3xl font-bold white line-height-normal">
                      ...
                      <div class="w-full">
                        ...
                        <div class="relative flex mb-4 groupButton">
                          ...
                          <div class="rightControl">
                            <button
                              class="cursor-pointer btn button primary"
    ...
    <div v-else class="pt-8 affiliatePage">
      <div class="w-full">
        ...
        <div class="m-6">
                ...
                <div class="vx-row">
                  <div class="w-full mb-4 vx-col lg:w-1/3">
                    <div class="boxBasic bgSecondary borderSecondary">
                      <div
                        class="flex items-center pb-3 mb-3 heading borderBtSecondary"
                      >
                        <div class="flex items-center boxRank">
                          ...
                          <div class="rank-text">
                            <p
                              class="cursor-pointer textRank noselect bgPrimary"
                            >
                      ...
                      <div class="body">
                        <h5
                          class="mb-3 text-center nextRankCondition colorSecondary"
                        >
                          Điều kiện Cấp bậc
                        </h5>
                        <div class="vx-row">
                          <div class="w-2/3 vx-col">
                            <p class="mb-2 text-base white-50 name">
                              F1 tổng (Tuần này)
                            </p>
                            <p
                              class="m-0 text-xl font-size-18 colorPrimary value"
                            >
                              <span class="colorSecondary"
                                >{{ hhMeF1isWeek }} /
                              </span>
                              <span class="colorGray" v-if="totalDlisMe < 3"
                                >1,000</span
                              >
                              <span class="colorGray" v-if="totalDlisMe == 3"
                                >2,000</span
                              >
                              <span class="colorGray" v-if="totalDlisMe == 4"
                                >4,000</span
                              >
                              <span class="colorGray" v-if="totalDlisMe == 5"
                                >6,000</span
                              >
                              <span class="colorGray" v-if="totalDlisMe == 6"
                                >8,000</span
                              >
                              <span class="colorGray" v-if="totalDlisMe >= 7"
                                >10,000</span
                              >
                            </p>
                          </div>
                  ...
                  <div class="w-full mb-4 vx-col lg:w-1/3">
                    <div class="affiliateInfo bgSecondary borderSecondary">
                      <div class="referralSponsor">
                        <p class="mb-0">
                          <span class="mb-2 text-xs colorSecondary"
                            >Người giới thiệu</span
                          >
                        </p>
                        <p>
                          <span class="mb-2 text-2xl colorSecondary value">{{
                            f1cuaminh != "" ? f1cuaminh : "-----"
                          }}</span>
                        </p>
                      </div>
                  ...
                  <div class="w-full mb-4 vx-col lg:w-1/3">
                    <div class="affiliateInfo bgSecondary borderSecondary">
                      <p
                        class="mb-3 text-base font-bold white affiliateInfo-title"
                  ...
                  <div class="w-full mb-4 vx-col lg:w-2/3">
                    <div
                          ...
                          <div class="content">
                            <div class="vx-row">
                              <div class="w-full vx-col lg:w-1/3">
                                <p
                                  class="my-4 text-xl font-bold white recent-statistics-title"
                                >
                                  Số liệu gần đây
                                </p>
                  ...
                  <div class="w-full mb-4 vx-col lg:w-1/3">
                    <div class="networkVolumeStats bgSecondary borderSecondary">
                      <div class="flex items-center cardHeader">
                        ...
                        <span
                          class="text-xl font-bold white networkVolumeStats-title"
                          >KLGD Cấp Dưới</span
                        >
                      ...
                      <div class="cardBody">
                        ...
                        >
                          <div class="vx-col lg:w-5/12">
                            <p class="m-0 text-sm capitalize texthead">Tháng</p>
                          </div>
                          <div class="vx-col lg:w-7/12">
                            <p class="m-0 text-sm capitalize texthead">tổng</p>
                          </div>
                        </div>
                  ...
                  <div class="w-full mb-4 vx-col lg:w-1/3">
                    <div class="getIntouch bgSecondary borderSecondary">
                      <div class="flex items-center cardHeader">
                        ...
                        ><span class="text-xl font-bold white getIntouch-title"
                          >Liên hệ</span
                        >
                      </div>
                      <div class="cardBody">
                        <div class="vx-row">
                          <div class="text-center vx-col lg:w-4/12">
                            ...
                            />
                            <p
                              class="mb-2 text-base elipText white getIntouch-sub-title"
                            >
                              Support001
                            </p>
                          </div>
          ...
          <div class="commission" :class="{ block: showCom }">
            <div class="wraperContent">
              <div
                class="flex flex-col items-center justify-between mb-4 headerContent lg:flex-row"
              >
                <h1
                  class="text-2xl font-bold white text-capitalize pointer affiliateCommission-title"
                >
                  Hoa hồng
                  <span class="q">
                    <feather-icon
              ...
              <div class="body vx-row">
                ...
                <div class="w-full mt-4 vx-col lg:mt-0">
                  <div
                    class="relative tableBackground bgSecondary trading-detail"
                    v-if="selectedHoaHong.id == 1"
                  >
                    <table
                      class="table w-full table-dark tableComission bgSecondary"
                        ...
                        <tr>
                          <th colspan="5">
                            <div class="flex items-center">
                              ...
                              ><span
                                class="text-lg font-bold white trading-detail-title"
              ...
              <div>
                <div class="filterDiv">
                  ...
                  <div class="flex flex-wrap">
                    <div class="relative align-middle colFirst lg:mr-5">
                      ...
                      <button
                        class="cursor-pointer btn search btnSearchType lg:mr-3 button"
                      ...
                      <button
                        class="cursor-pointer btn search btnSearchType button"
                ...
                <div class="paddingResult">
                  <div class="flex flex-wrap mb-3">
                    ...
                    <div
                      class="flex flex-wrap items-center ml-auto scrollRange"
                    >
                      <span class="mr-4 textTime">Khoảng thời gian:</span>
                      <button
                        class="mr-3 cursor-pointer btn btnTime"
                      ...
                      <button
                        class="cursor-pointer btn btnTime"
                  ...
                  <div class="search-result">
                    <div class="relative table-responsive table-pc">
                      <table
                        class="table w-full mb-0 overflow-hidden text-center table-bordered"
                        :class="{ 'ld-loading': isLoading }"
                      >
                        <div class="loading">
                          <div class="loading__ring">
