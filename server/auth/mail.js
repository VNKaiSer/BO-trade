...
let listemail = [
	'noreply@metanex.org', 'no-reply@metanex.org'
];

// Vì để demo nên mình để các biến const ở đây.
const adminEmail = 'metanex.org@gmail.com'
const adminPassword = 'Xinchao123'
// Mình sử dụng host của google - gmail
const mailHost = 'server1.metanex.org'
// 587 là một cổng tiêu chuẩn và phổ biến trong giao thức SMTP
const mailPort = 25; //587 //25
const sendMail = (to, subject, htmlContent) => {
  ...
  const options = {
    from: `PANAZIC <${listemail[rd]}>`, // địa chỉ admin email bạn dùng để gửi
